...
----------------------------------------------------
-- MINIGIERKA AKUMULATOR
----------------------------------------------------

local batteryGame = false
local currentCable = 1
...
function(vehicle)
    ...
    if batteryGame then return end
    ...
    outputChatBox(
        "Podłącz kabel: "..cables[currentCable][1],
        255,255,0
    )
...
function(button, press)
    ...
    local expected = cables[currentCable][2]

    ----------------------------------------------------
    -- RED
    ----------------------------------------------------

    if expected == "red" and button == "1" then
    ...
    elseif expected == "blue" and button == "2" then
    ...
    elseif expected == "green" and button == "3" then
    ...
    if currentCable > #cables then

        batteryGame = false

        outputChatBox(
            "Akumulator podłączony poprawnie!",
            0,255,0
        )

        triggerServerEvent("pd:finishBatteryRepair",localPlayer,currentVehicle)
