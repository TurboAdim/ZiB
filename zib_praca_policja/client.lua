...
local recallVehicleButton = guiCreateButton(
    0.05,
    0.74,
    0.12,
    0.05,
...
local function setFontToButtons(font)
	...
	guiSetFont(recallVehicleButton, font)
end
...
addEventHandler("onClientGUIClick",recallVehicleButton,
    function()
        triggerServerEvent("police:recallVehicle",localPlayer)
    end,
    false
)
