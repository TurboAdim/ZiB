...
addEvent("criminal:createMissionArea", true)
addEventHandler("criminal:createMissionArea", root,

function(x, y, width, height)

    if isElement(missionArea) then
        destroyElement(missionArea)
    end

    missionArea = createRadarArea(
        x,
        y,
        width,
        height,
...
addEvent("criminal:clearMissionArea", true)

addEventHandler("criminal:clearMissionArea", root,
