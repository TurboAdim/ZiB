...
function startJob(model)
    ...
    ----------------------------------------------------
    -- SPRAWDZENIE CZY GRACZ JUŻ PRACUJE
    ----------------------------------------------------
    ...
    ----------------------------------------------------
    -- ZNALEZIENIE WYBRANEJ CIĘŻARÓWKI
    ----------------------------------------------------
    ...
    if session.accelerationUpgrade then
        ...
        if handling
            and handling.acceleration then

            setVehicleHandling(
                veh,
                "acceleration",
                handling.acceleration + 20
            )
...
function selectCargo(cargoID)
    ...
    ----------------------------------------------------
    -- SPRAWDZENIE CZY MOŻNA ZAŁADOWAĆ
    ----------------------------------------------------
