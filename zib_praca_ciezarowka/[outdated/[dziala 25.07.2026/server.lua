...
data.refillTimer =
    setTimer(
        function()
            ...
            ----------------------------------------------------
            -- SPRAWDZENIE CZY GRACZ NADAL JEST W TYM TRUCKSTOPIE
            ----------------------------------------------------

            if truckerData.currentTruckStop
                ~= currentTruckStop then

                truckerData.refillingRoutes = false

                if truckerData.refillTimer
                    and isTimer(truckerData.refillTimer) then
...
if truckerData.refillTimer and isTimer(truckerData.refillTimer) then
    killTimer(truckerData.refillTimer)
end
    ...
    killTimer(truckerData.refillTimer)
            ...
            ----------------------------------------------------
            -- SPRAWDZENIE CZY TACHOGRAF ZOSTAŁ W PEŁNI NAŁADOWANY
            ----------------------------------------------------
...
addCommandHandler("sprawdz.tacho",
    function(player)
        ...
        outputChatBox("Sprawdzanie tachografu...", player, 255,255,0)
...
local maxRoutes =
    Config.MaxRoutes or 10
            ...
            ----------------------------------------------------
            -- TACHOGRAF (tylko policjant widzi wynik)
            ----------------------------------------------------
